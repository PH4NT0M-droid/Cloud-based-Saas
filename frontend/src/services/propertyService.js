...
const propertyService = {
  ...
  create: (payload) => api.post('/properties', normalizePayload(payload)).then((res) => res.data.data),
  update: (id, payload) => api.put(`/properties/${id}`, normalizePayload(payload)).then((res) => res.data.data),
